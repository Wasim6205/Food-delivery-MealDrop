...
const Shop = () => {
  ...
  return (
    ...
    <button onClick={()=>navigate('/')} className='absolute cursor-pointer top-4 left-4 z-20 flex items-center gap-2 bg-black/50 hover:bg-black/70 text-white px-3 py-2 rounded-full shadow transition'>
        <FaArrowLeft />
        <span>Back</span>
    </button>
      ...
      {shop && <div className='relative w-full h-64 md:h-80 lg:h-96'>
        ...
        <div className='absolute inset-0 bg-gradient-to-b from-black/70 to-black/30 flex flex-col justify-center items-center text-center px-4'>
            ...
            <h1 className='tetx-3xl md:text-5xl font-extrabold text-white drop-shadow-lg'>{shop.name}</h1>

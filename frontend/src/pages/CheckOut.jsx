  ...
  const getAddressByLatLng = async (lat, lng) => {
    try {
      const result = await axios.get(
        `${serverUrl}/api/location/geocode?lat=${lat}&lon=${lng}`
      );
      ...
      <div className="w-full max-w-[900px] bg-white rounded-2xl shadow-xl p-6 space-y-6">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div onClick={()=>setPaymentMethod("cod")} className={`flex items-center cursor-pointer gap-3 rounded-xl border p-4 text-left transition ${paymentMethod==="cod" ? "border-[#ff4d2d] bg-orange-50 shadow" : "border-gray-200 hover:border-gray-300"}`}>
            ...
            <div onClick={()=>setPaymentMethod("online")} className={`flex items-center cursor-pointer gap-3 rounded-xl border p-4 text-left transition ${paymentMethod==="online" ? "border-[#ff4d2d] bg-orange-50 shadow" : "border-gray-200 hover:border-gray-300"}`}>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Pay Securely</p>
              </div>
            </div>
          </div>
        </section>

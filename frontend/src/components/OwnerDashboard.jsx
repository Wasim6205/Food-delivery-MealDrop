    ...
    <div className='w-full min-h-screen bg-[#fff9f6] flex flex-col items-center'>
        ...
        <div className='flex justify-center items-center p-4 sm:p-6'>
          <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
            <div className='flex flex-col items-center text-center'>
              ...
              <button onClick={()=>navigate("/create-edit-shop")} className='bg-[#ff4d2d] text-white px-5 sm:px-6 py-2 rounded-full font-medium shadow-md cursor-pointer hover:bg-orange-600 transition-colors duration-200'>Get Started</button>
            </div>
          </div>
        </div>
      }
      ...
      {myShopData && <div className='w-full flex flex-col items-center gap-6 px-4 sm:px-6'>
        ...
        <div className='bg-white shadow-lg rounded-xl overflow-hidden border border-orange-100 hover:shadow-2xl transition-all duration-300 w-full max-w-3xl relative'>
          <div onClick={()=>navigate('/create-edit-shop')} className='absolute top-4 right-4 bg-[#ff4d2d] text-white cursor-pointer p-2 rounded-full shadow-md hover:bg-orange-600 transition-colors'>
            <FaPen size={20} />
          </div>
        ...
        {myShopData.items.length==0 && <div className='flex justify-center items-center p-4 sm:p-6'>
          <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
            <div className='flex flex-col items-center text-center'>
              ...
              <button onClick={()=>navigate("/add-item")} className='bg-[#ff4d2d] text-white px-5 sm:px-6 py-2 rounded-full font-medium shadow-md cursor-pointer hover:bg-orange-600 transition-colors duration-200'>Add Food</button>
            </div>
          </div>
        </div>}

      ...
      <div className='flex flex-col justify-between p-3 flex-1'>
        ...
        <div className='flex items-center justify-between'>
            ...
            <div className='flex items-center gap-2 text-[#ff4d2d]'>
                <div onClick={()=>navigate(`/edit-item/${data._id}`)} className='p-2 rounded-full cursor-pointer hover:bg-[#ff4d2d]/10 text-[#ff4d2d]'>
                    <FaPen size={16} />
                </div>
                <div onClick={handleDelete} className='p-2 rounded-full cursor-pointer hover:bg-[#ff4d2d]/10 text-[#ff4d2d]'>
                    <FaTrashAlt size={16} />
                </div>
            </div>
        </div>
